...
public:
    ...
    [[nodiscard("error results should be checked")]] inline Result<void> update(_PyStackChunk* chunk_addr);
...
// ----------------------------------------------------------------------------
[[nodiscard("error results should be checked")]] Result<void> StackChunk::update(_PyStackChunk* chunk_addr)
{
    _PyStackChunk chunk;
