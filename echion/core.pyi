...
# Stack capture
def capture_thread_stack(native_id: int) -> list[str]: ...

def on_task_started(thread_ident: int, task: Task) -> None: ...
def on_task_finished(task: Task) -> None: ...

def on_task_submitted_to_executor(thread_ident: int, func: Callable, fut: Future) -> None: ...
def on_task_completed_by_executor(fut: Future) -> None: ...
