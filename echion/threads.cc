...
const char* ThreadInfo::Error::what() const noexcept
{
    return "Cannot create thread info object";
}

const char* ThreadInfo::CpuTimeError::what() const noexcept
{
    return "Cannot update CPU time";
}

ThreadInfo::ThreadInfo(uintptr_t thread_id, unsigned long native_id, const char* name)
